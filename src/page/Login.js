    ...
    <div className="p-3 md:p-4">
      <div className="w-full max-w-sm bg-white m-auto flex items-center flex-col p-4">
        ...
        <form className="w-full py-3 flex flex-col" onSubmit={handleSubmit}>
          ...
          <label htmlFor="password" className="text-lg font-semibold text-gray-700">Fjalekalimi</label>
          <div className="flex px-2 py-1 bg-gray-200 rounded mt-1 mb-2 focus-within:outline focus-within:outline-blue-300">
            <input
              type={showPass ? "text" : "password"}
              id="password"
              name="password"
              className="w-full bg-gray-200 border-none outline-none "
              value={data.password}
              onChange={handleOnChange}
            />
            <span
